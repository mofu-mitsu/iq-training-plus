...
code = code.replace('export const mathQuestions = [', 'export const mathQuestions = [\n' + newMath);
code = code.replace('export const logicQuestions = [', 'export const logicQuestions = [\n' + newLogic);
code = code.replace('export const vocabularyQuestions = [', 'export const vocabularyQuestions = [\n' + newVocab);
